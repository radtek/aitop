...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.10 2008-05-03 08:02:18 GMT")
...
{
	short soap_flag__cp_USCOREid = 1, soap_flag__serviceid = 1, soap_flag__usernumber = 1, soap_flag__timelen = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;

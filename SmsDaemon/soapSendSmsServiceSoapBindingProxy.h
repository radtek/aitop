...
{   public:
	...
	{ soap = soap_new(); endpoint = "http://220.194.56.196:8080/calldownsms/services/SendSmsService?wsdl"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual int ns1__send(int _cp_USCOREid, int _serviceid, char *_usernumber, int _timelen, int &_sendReturn) { return soap ? soap_call_ns1__send(soap, endpoint, NULL, _cp_USCOREid, _serviceid, _usernumber, _timelen, _sendReturn) : SOAP_EOM; };
	/// Invoke 'send' of service 'SendSmsServiceSoapBinding' and return error code (or SOAP_OK)
	virtual int ns1__send_(int _cp_USCOREid, int _serviceid, char *_usernumber, int _timelen, int &_sendReturn) { return soap ? soap_call_ns1__send_(soap, endpoint, NULL, _cp_USCOREid, _serviceid, _usernumber, _timelen, _sendReturn) : SOAP_EOM; };

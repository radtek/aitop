...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.10 2008-05-13 07:23:42 GMT")
...
{
	short soap_flag__spID = 1, soap_flag__serviceID = 1, soap_flag__userNumber = 1, soap_flag__rank = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
